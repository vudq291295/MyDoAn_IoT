...
import com.dqv.smarthome.Activity.AddScheduleKBActivity;
...
public class ScheduleKBAdapter extends RecyclerView.Adapter<ScheduleHolder> {
    public static final String TAG = ScheduleKBAdapter.class.getSimpleName();
    ...
    public ScheduleKBAdapter(ArrayList<ScheduleModel> mRoomsLst, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ScheduleHolder scheduleHolder, final int i) {
        ...
        scheduleHolder.mEquip.setText(mEquipst.get(i).getScriptName()+"");
        ...
        scheduleHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, AddScheduleKBActivity.class);
                ...
                bundle.putInt("scriptID",mEquipst.get(i).getScriptID());
